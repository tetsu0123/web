...
const VERSION='suit-shift-v1.0.0';
const CACHE=VERSION+'-'+self.registration.scope;
const FILES=['./','./index.html','./manifest.webmanifest','./assets/icon.svg','./src/core.js','./src/levels.js','./src/app.js','./src/style.css','./src/hint-worker.js'];
