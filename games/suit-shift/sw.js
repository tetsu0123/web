...
const VERSION='suit-shift-v2.0.0';
const CACHE=VERSION+'-'+self.registration.scope;
const FILES=['./','./index.html','./manifest.webmanifest','./assets/icon.svg','./src/core.js','./src/core.js?v=2.0.0','./src/levels.js?v=2.0.0','./src/app.js?v=2.0.0','./src/style.css?v=2.0.0','./src/casino.css?v=2.0.0','./src/hint-worker.js?v=2.0.0'];
