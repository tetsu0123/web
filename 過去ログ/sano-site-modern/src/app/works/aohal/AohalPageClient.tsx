...
export default function AohalPageClient() {
  return (
    <Layout>
      <Container>
        <Title
        ...
        <HeroSection>
          ...
          <BookInfo>
            ...
            <Links>
              <LinkButton href="https://www.amazon.co.jp/dp/4049120372" target="_blank" rel="noopener">
                Amazonで購入
              </LinkButton>
        ...
        <Section>
          ...
          <Content>
            ...
            <p>
              クラスで一番ポイントの低い<strong>春日唯</strong>は42ポイント。彼女は孤立していて、誰とも関わりを持とうとしない。
            </p>
            <p>
        ...
        <BackLink href="/works">作品一覧へ戻る</BackLink>
      </Container>
    </Layout>
  )
}